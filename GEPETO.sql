...
AS
BEGIN
	SELECT * FROM [TB_GROUP] WHERE ID_GROUP = @group_id
END
GO
...
AS
BEGIN
	IF @full_name IS NOT NULL AND @graduate IS NULL
		UPDATE TB_STUDENT 
			SET FULL_NAME = @full_name
			WHERE RM = @rm
	ELSE IF @full_name IS NULL AND @graduate IS NOT NULL
		UPDATE TB_STUDENT 
...
BEGIN
	IF EXISTS (SELECT * FROM [TB_GROUP_STUDENT] WHERE [RM] = @rm)
		DELETE FROM [TB_GROUP_STUDENT] WHERE [RM] = @rm
	DELETE FROM TB_STUDENT WHERE [RM] = @rm
END
GO
CREATE PROCEDURE SP_FIND_STUDENT
(
	@rm CHAR(6)
)
AS
BEGIN
	SELECT * FROM [TB_STUDENT] WHERE [RM] = @rm
END
GO
...
AS
	...
	END
GO
CREATE PROCEDURE SP_UPDATE_GROUP_STUDENT
(
	@rm CHAR(6),
	@new_group_theme VARCHAR(50)
)
AS
BEGIN
...
END
GO
CREATE PROCEDURE SP_DELETE_GROUP_STUDENT
(
	@rm CHAR(6)
)
AS
...
END
GO
CREATE PROCEDURE SP_FIND_GROUP_STUDENT
(
	@rm CHAR(6)
)
AS
BEGIN
	SELECT * FROM [TB_GROUP_STUDENT] WHERE [RM] = @rm
END
GO
